      ...
      <div className="pt-10 w-full lg:w-[60%]">
            ...
            <div className="lg:flex gap-32">
              <div className="space-y-7">
                ...
                <div className="flex">
                  ...
                  <p className="text-gray-500">{"Dhiraj Sardar"} </p>
                </div>
                <div className="flex">
                  <p className="w-[9rem]">Date Of Birth : </p>
                  <p className="text-gray-500">{"25/03/2000"} </p>
                </div>
                <div className="flex">
              ...
              <div className="space-y-7">
                ...
                <div className="flex">
                  ...
                  <p className="text-gray-500">{560090} </p>
                </div>
                <div className="flex">
        ...
        <Card className="w-full">
            ...
            <CardContent className="space-y-5">
              ...
              <div>
                <Dialog margin="12px" defaultOpen={false}> 
                  <DialogTrigger>
            ...
            <CardHeader className="pb-7">
              <div className="flex items-center gap-3">
                ...
                {auth.user.verified ? (
                  ...
                  <Badge className="bg-orange-500">verified</Badge>
                )}
              </div>
            </CardHeader>
            <CardContent className="space-y-5">
